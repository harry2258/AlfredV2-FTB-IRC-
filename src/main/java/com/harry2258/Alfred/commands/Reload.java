    ...
    public boolean execute(MessageEvent event) {
        if (!config.useDatabase) {
            try {
                ...
                //No Santa, I didn't want to add just Exception but GSon only throws Exception.
                e.printStackTrace();
            }
        } else {
        ...
        return false; //Line 39 and Line 66 will return true if it reloaded. Else return false.
    }
